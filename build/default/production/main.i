...
void main(void) {
    ...
    while(1) {
        ...
        if(PORTAbits.AN2 && IS_ON && IS_MMC){
            T2CONbits.TMR2ON = 1;
        }else {
            T2CONbits.TMR2ON = 0;
        }
        if(PORTAbits.AN0 && !POWER_BF){
            POWER_BF = 1;
            IS_ON = !IS_ON;
            if(IS_ON) {
                PORTCbits.RC1 = 1;
        ...
        } else if(!PORTAbits.AN0 && POWER_BF){
            POWER_BF = 0;
        }

        if(PORTAbits.AN1 && IS_ON && !MMC_BF){
            MMC_BF = 1;
            IS_MMC = !IS_MMC;
            PORTCbits.RC4 = IS_MMC;
        } else if(!PORTAbits.AN1 && MMC_BF){
            MMC_BF = 0;
        }
    }
